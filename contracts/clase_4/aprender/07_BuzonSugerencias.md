...
1. [Tipos de Referencia en Solidity y data location](https://github.com/argotorg/solidity/tree/develop/docs/types/reference-types.rst)
...
3. [Layout y Disposición de Variables de Estado en Storage](https://github.com/argotorg/solidity/tree/develop/docs/internals/layout_in_storage.rst)
4. [Estructura y Comportamiento de Variables de Memoria Dinámica](https://github.com/argotorg/solidity/tree/develop/docs/internals/layout_in_memory.rst)
5. [Especificación y Codificación de Argumentos de Entrada en Calldata](https://github.com/argotorg/solidity/tree/develop/docs/internals/layout_in_calldata.rst)
6. [Funcionamiento del Optimizador de Solidity y Yul](https://github.com/argotorg/solidity/tree/develop/docs/internals/optimizer.rst)
7. [Tipos de Valor e Inicialización de Variables en Solidity](https://github.com/argotorg/solidity/tree/develop/docs/types/value-types.rst)
8. [Tipos de Mappings y Distribución de Claves de Almacenamiento](https://github.com/argotorg/solidity/tree/develop/docs/types/mapping-types.rst)
9. [Seguridad y Consideraciones de Diseño de Contratos](https://github.com/argotorg/solidity/tree/develop/docs/security-considerations.rst)
10. [Especificación de la Interfaz Binaria de Aplicación (ABI)](https://github.com/argotorg/solidity/tree/develop/docs/abi-spec.rst)
11. [Guía de Compilación de Solidity y Opcodes de la EVM](https://github.com/argotorg/solidity/tree/develop/docs/using-the-compiler.rst)
